...
class ButtonStyle {
  defaultStyle: object = {
    root: {
      ...
      )}, box-shadow ${formatMs(theme.transitions.duration.short)}`,
      '&:hover': {
        textDecoration: 'none',
  ...
  setup(style: object) {
    ...
    rippleColors.default = fade(theme.palette.text.primary, 0.3);
    rippleColors.primary = fade(theme.palette.primary[500], 0.3);
    rippleColors.secondary = fade(theme.palette.secondary['A200'], 0.3);
