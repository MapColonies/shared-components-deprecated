...
import { Menu, MenuItems, MenuSurfaceAnchor } from '../../../../menu';
...
type SiteSearchItemT = {
  ...
  htmlSnippet: string; //"npm i ../../../../<b>button</b> --save or yarn add ../../../../<b>button</b>; Include the individual <br>↵components stylesheets (listed on their docs page) in your project via your <br>↵method&nbsp;..."
  ...
  snippet: string; //"npm i ../../../../button --save or yarn add ../../../../button; Include the individual ↵components stylesheets (listed on their docs page) in your project via your ↵method ..."
