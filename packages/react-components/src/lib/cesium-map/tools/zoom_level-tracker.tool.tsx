...
export const ZoomLevelTrackerTool: React.FC<RZoomLevelTrackerToolProps> = (
    ...
    const calculateZoomLevel = () => {
      ...
      switch(mapViewer.scene.mode) {
        ...
        case CesiumSceneMode.SCENE2D:
          cameraHeight = ((camera.frustum as PerspectiveOffCenterFrustum).right - (camera.frustum as PerspectiveOffCenterFrustum).left) * ORTHOPHOTO_HEIGHT_FRUSTRUM_FACTOR;
          break;
  ...
  return <div className="zoomLevel">
